...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WP_Customize_Control_Separator extends \WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'wp-customize-control-separator', get_theme_file_uri( 'styles/wp-customize-control-separator.css' ), [], filemtime( get_theme_file_path( 'styles/wp-customize-control-separator.css' ) ), 'all' );
		}
