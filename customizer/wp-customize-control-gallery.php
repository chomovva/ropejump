...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WP_Customize_Control_Gallery extends \WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				'wp-customize-control-gallery',
				get_theme_file_uri( 'scripts/wp-customize-control-gallery' . $suffix . '.js' ),
				[ 'jquery', 'customize-preview', 'wp-util' ],
				filemtime( get_theme_file_path( 'scripts/wp-customize-control-gallery' . $suffix . '.js' ) ),
				true
			);
			wp_set_script_translations( 'wp-customize-control-gallery', $this->textdomain );
			wp_localize_script( 'wp-customize-control-gallery', $this->id . 'Args', [
			...
			wp_enqueue_style(
				'wp-customize-control-gallery',
				get_theme_file_uri( 'styles/wp-customize-control-gallery' . $suffix . '.css' ),
				[],
				filemtime( get_theme_file_path( 'styles/wp-customize-control-gallery' . $suffix . '.css' ) ),
				'all'
			);
		}
