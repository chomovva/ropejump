...
add_action( 'template_redirect', 'ropejump\single_result_redirect' );
...
add_filter( 'the_content', 'ropejump\search_backlight' );

add_filter( 'get_the_excerpt', 'ropejump\search_backlight' );

add_filter( 'the_title', 'ropejump\search_backlight' );
...
add_filter( 'the_permalink', 'ropejump\add_search_key_for_backlight', 10, 2 );